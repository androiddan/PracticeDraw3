...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float len=paint1.measureText(text1,0,text1.length());
        float len2=paint2.measureText(text2,0,text2.length());

        canvas.drawText(text1, 50, 200, paint1);
        canvas.drawText(text2, 50 + len, 200, paint2);
        canvas.drawText(text3, 50 + len+len2, 200, paint1);
    }
}
